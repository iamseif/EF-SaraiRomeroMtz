            ...
            <Container>
                <Row>
                    <Col lg="4">
                        <div className="logo"> 
                            <div>
                                <h1 className="text-white">RelieveMart</h1>
                            </div>
                        </div>

                        <p className="footer__text mt-4">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                            Dignissimos ex eos vel eveniet sed natus mollitia inventore quisquam sunt obcaecati!
                        </p>
